...
private val LocalColors =
    compositionLocalOf<PokedexColors> {
        error(
            "No colors provided! Make sure to wrap all usages of Pokedex components in PokedexTheme."
        )
    }
...
/**
 * Contains ease-of-use accessors for different properties used to style and customize the app look
 * and feel.
 */
object PokedexTheme {
    ...
    val background: PokdexBackground
        @Composable @ReadOnlyComposable get() = LocalBackgroundTheme.current
}
