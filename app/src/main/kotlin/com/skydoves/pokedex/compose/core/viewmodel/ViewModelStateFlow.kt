...
/**
 * The ViewModel state flow currently relies solely on delegating [MutableStateFlow] inside the
 * [BaseViewModel] to prevent modification of values from outside the ViewModels.
 *
 * However, this class should be transitioned to utilize explicit backing fields (referenced in
 * [this proposal](https://github.com/Kotlin/KEEP/blob/explicit-backing-fields-re/proposals/explicit-backing-fields.md))
